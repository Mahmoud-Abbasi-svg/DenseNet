# -*- coding: utf-8 -*-
"""
Created on Fri Feb 25 23:58:28 2022
...
class DenseNet(nn.Module):
    def __init__(self, nr_classes):
        ...
        self.pre_classifier = nn.Linear(in_features=64*4*4, out_features=512)
        self.classifier = nn.Linear(in_features=512, out_features=nr_classes)
        
    def _make_dense_block(self, block, in_channels):
        layers = []
        layers.append(block(in_channels)) # creat an instance of class
        return nn.Sequential(*layers)
    
    def _make_transition_layer(self, layer, in_channels, out_channels):
        modules = []
        modules.append(layer(in_channels, out_channels)) # creat an instance of class
